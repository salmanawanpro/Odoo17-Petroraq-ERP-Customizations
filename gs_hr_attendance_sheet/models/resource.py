...
class ResourceCalendar(models.Model):
    ...
    def att_get_work_intervals(self, day_start, day_end,tz):
        ...
        attendance_intervals = self._leave_intervals(day_start, day_end)
        working_intervals = []
    ...
    def att_get_work_intervals_new(self, day_start, day_end, tz):
        ...
        att_work_intervals = self._leave_intervals(day_start_utc,
                                                   day_end_utc)
